...
<body class="bg-black">
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a href="Home.php" class="nav-link active text-light fw-bolder">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="About.php" class="nav-link active text-light">About</a>
                    </li>
                    <li class="nav-item">
                        <a href="Menu.php" class="nav-link active text-light">Menu</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a href="Login.php" class="nav-link"><button type="button" class="btn btn-outline-warning">Log in</button></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div id="carouselExample2" class="carousel slide">
            <div class="carousel-inner">
                <h2 class="text-light fw-bolder d-flex justify-content-center">Hot Coffee</h1>
                <div class="carousel-item active">
                    <div class="container d-flex justify-content-center">
                        <div class="row m-2">
                            <div class="col m-3">
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Velvet Coffee</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">Caramel chocolate</small></p>
                                                <p class="card-text fw-bold">$5.2</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Vanilla Coffee</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">With Chocolate</small></p>
                                                <p class="card-text fw-bold">$7.8</p>
                                            </div>
                                        </div>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Cinnamon Coffee</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">With Espresso Shot</small></p>
                                                <p class="card-text fw-bold">$6.3</p>
                                            </div>
                                        </div>
                                ...
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Decaf Coffee</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">Small, Meduin, Large</small></p>
                                                <p class="card-text fw-bold">$7.8</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container">
        <div id="carouselExample3" class="carousel slide">
            <div class="carousel-inner">
                <h2 class="text-light fw-bolder d-flex justify-content-center">Desserts</h1>
                <div class="carousel-item active">
                    <div class="container d-flex justify-content-center">
                        <div class="row m-2">
                            <div class="col m-3">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                ...
                                                <p class="card-text"><small class="text-body-secondary-white">1 Slice</small></p>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Choco Fantasy</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">5 Pieces</small></p>
                                                <p class="card-text fw-bold">$2.99</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Choco Fudge</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">1 Slice</small></p>
                                                <p class="card-text fw-bold">$1.99</p>
                                            </div>
                                        </div>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Vanilla Scoop</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">1 Slice</small></p>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Berry Cheesecake</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">1 Slice</small></p>
                                                <p class="card-text fw-bold">$1.99</p>
                                            </div>
                                        </div>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Starberry Cake</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">1 Slice</small></p>
                                                <p class="card-text fw-bold">$3.99</p>
                                            </div>
                                        </div>
                            ...
                            <div class="col m-3">
                                <div class="card mb-3 bg-black bg-gradient" style="max-width: 320px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                <h5 class="card-title">Relvet Cake</h5>
                                                <p class="card-text"><small class="text-body-secondary-white">1 Slice</small></p>
                                                <p class="card-text fw-bold">$4.99</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-white">
                                                ...
                                                <p class="card-text"><small class="text-body-secondary-white">3 Pieces</small></p>
